...
def generate_ore_irm_data() -> pd.DataFrame:
    ...
    ores = [
        # --- Valid Risk Level 2 (source provenance) ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Technology > Infrastructure > Network Services",
            "ORE Rating": "High",
        ...
        # --- Blank Risk Level 2 (mapper fallback) ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Global Services > Payments Ops > Settlement",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
        ...
        # --- Invalid Risk Level 2 (WARNING + mapper fallback) ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Enterprise Functions > Procurement > Vendor Management",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
        ...
        # --- Privacy event, in progress ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Consumer Services > Card Operations > Account Servicing",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
        ...
        # --- Capture Status = cancelled (must NOT be filtered out) ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Consumer Services > Fraud Operations > Disputes",
            "ORE Rating": "Low",
        ...
        # --- Blank Legacy Event ID (most common) ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Enterprise Functions > Risk Management > Model Governance",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
        ...
        # --- Risk Level 2 with L1 prefix (valid via prefix strip) ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Global Commercial Services > Client Management > CRM",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
        ...
        # --- Long description (truncation test) ---
        {
            ...
            "ORE Owner Business Unit (L1, L2, L3)": "Global Services > Payments Ops > Clearing",
            "ORE Rating": "High",
            "Capture Status": "In Progress",
