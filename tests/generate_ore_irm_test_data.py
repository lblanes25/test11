...
def generate_ore_irm_data() -> pd.DataFrame:
    ...
    ores = [
        ...
        # --- Invalid Risk Level 2 (WARNING + mapper fallback) ---
        {
            ...
            "Business Unit (L1, L2, L3)": "Enterprise Functions > Procurement > Vendor Management",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
        ...
        # --- Capture Status = cancelled (must NOT be filtered out) ---
        {
            ...
            "Business Unit (L1, L2, L3)": "Consumer Services > Fraud Operations > Disputes",
            "ORE Rating": "Low",
        ...
        # --- Blank Legacy Event ID (most common) ---
        {
            ...
            "Business Unit (L1, L2, L3)": "Enterprise Functions > Risk Management > Model Governance",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
        ...
        # --- Risk Level 2 with L1 prefix (valid via prefix strip) ---
        {
            ...
            "Business Unit (L1, L2, L3)": "Global Commercial Services > Client Management > CRM",
            "ORE Rating": "Medium",
            "Capture Status": "In Progress",
